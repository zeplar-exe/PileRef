...
public static class DocumentTypeEnum
{
    ...
    public static readonly DocumentType DOCX = new("DOCX", [".docx"]);
    ...
    public static readonly DocumentType PNG = new("PNG", [".png"]);
    public static readonly DocumentType JPG = new("JPG", [".jpg", "jpeg"]);
    public static readonly DocumentType BMP = new("BMP", [".bmp"]);
